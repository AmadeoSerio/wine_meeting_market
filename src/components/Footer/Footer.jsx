...
const Footer = () => {
  return (
    <div className='footer-div container'>
        ...
        <p>Seguinos en Instragram  <a target='blank' href="https://www.instagram.com/wine.meeting_/"><i className="fa-brands fa-instagram"></i></a></p>

        <p>Comunicate con nosotras por WhatsApp <a target='blank' href="https://api.whatsapp.com/send/?phone=5492612051027&text&type=phone_number&app_absent=0"><i className="fa-brands fa-whatsapp"></i></a></p>
